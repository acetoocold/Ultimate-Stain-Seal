...
export const ListDiagnosesResponseItem = zod.object({
  ...
  recommendedProductType: zod.string().nullish(),
  recommendedCoats: zod.number().nullish(),
  productColor: zod.string().nullish(),
...
export const GetDiagnosisResponse = zod.object({
  ...
  createdAt: zod.string(),
  updatedAt: zod.string(),
  customer: zod.object({ id: zod.number(), firstName: zod.string(), lastName: zod.string() }).nullish(),
  project: zod.object({ id: zod.number(), serviceType: zod.string() }).nullish(),
});
...
export const ListMaterialsResponseItem = zod.object({
  ...
  oilType: zod.string().nullish(),
  containerCapacity: zod.number().nullish(),
  brand: zod.string().nullish(),
  description: zod.string().nullish(),
  unitType: zod.string(),
  unitCost: zod.number().nullish(),
...
export const CreateMaterialBody = zod.object({
  ...
  trackingType: zod.enum(["quantity", "status", "both"]).nullish(),
  oilType: zod.string().nullish(),
  containerCapacity: zod.number().nullish(),
  brand: zod.string().nullish(),
  description: zod.string().nullish(),
...
export const ListInventoryResponseItem = zod.object({
  ...
  colorContent: zod.string().nullish(),
  contentDescription: zod.string().nullish(),
