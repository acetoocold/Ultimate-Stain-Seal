...
export const materialsTable = pgTable("materials", {
  ...
  sku: text("sku"),
  category: text("category").notNull().default("stain"),
  brand: text("brand"),
  description: text("description"),
  unitType: text("unit_type").notNull().default("gallon"),
  unitCost: numeric("unit_cost", { precision: 10, scale: 2 }),
  retailPrice: numeric("retail_price", { precision: 10, scale: 2 }),
  homeDepotPrice: numeric("home_depot_price", { precision: 10, scale: 2 }),
  homeDepotSku: text("home_depot_sku"),
